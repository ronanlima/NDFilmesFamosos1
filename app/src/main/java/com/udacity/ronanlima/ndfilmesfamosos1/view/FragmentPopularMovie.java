...
public class FragmentPopularMovie extends Fragment implements TheMovieDBConsumer.ListenerResultSearchTMDB {
    ...
    public void verifyInternetConnection() {
        if (NetworkUtils.isConnected(getActivity())) {
            TheMovieDBConsumer.getMovies(this, MainActivity.PATH_POPULAR_MOVIE);
        } else {
