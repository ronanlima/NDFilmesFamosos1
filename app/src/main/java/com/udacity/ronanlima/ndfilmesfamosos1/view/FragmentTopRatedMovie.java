...
public class FragmentTopRatedMovie extends BaseMovieFragment implements TheMovieDBConsumer.ListenerResultSearchTMDB {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        init();
        verifyInternetConnection(this, movieListViewModel, MainActivity.PATH_TOP_RATED_MOVIE);
